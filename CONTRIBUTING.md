...
As contributors and maintainers of the Firebase ChatBot Codelab project, we pledge to respect everyone who contributes by posting issues, updating documentation, submitting pull requests, providing feedback in comments, and any other activities.
...
If you have questions about how to use the Firebase ChatBot Codelab, please direct these to [StackOverflow][stackoverflow] and use the `firebase` tag. We are also available on GitHub issues.
...
* Search [GitHub](https://github.com/firebase/chatbot/pulls) for an open or closed Pull Request
...
* In GitHub, send a pull request to `chatbot:master`.
...
[github]: https://github.com/firebase/chatbot
